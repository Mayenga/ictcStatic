...
<head>
  ...
  <title>Information and Communication Technology Commission - News</title>
                    ...
                    <div class="col-xm-12 col-sm-12 col-lg-9 col-12 justify-content-center">
                        <div class="card" style="width: 100%;">
                            <div style="margin:10px">
                                <h3>Director General of the ICT Commission had a meeting with EU delegate</h3>
                                <span style="color:blue">May 9, 2022</span>
                            </div>
                            <img class="card-img-top" height="100%" width="auto" src="../../siteimg/news/estonia/3.jpeg" alt="Ambassador of Netherlands">
                            <div class="card-body">
                                <h5 class="card-title"></h5>
                                <p class="card-text">Chairman of the board and Director General of the ICT Commission had a meeting with EU delegate at the sidelines of the conference in Tallinn Estonia. The meeting focused on the Digital for Development(D4D) grant application that covers: #1. Digital skills for SMEs #2. Digital security for all #3. Digital Economy and #4. Digital Innovation and Research for building startup ecosystem . The grant is going to strengthen partnership between Tanzania and Estonia in the area of ICT.</p>
                            </div>
                        </div>
                    </div>
                </div>
