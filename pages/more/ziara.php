                    ...
                    <div class="col-xm-12 col-sm-12 col-lg-9 col-12 justify-content-center">
                        <div class="card" style="width: 100%;">
                            <div style="margin:10px">
                                <h3>Ziara Balozi wa Netherlands Nchini Tanzania</h3>
                                <span style="color:blue">April 14, 2022</span>
                            </div>
                            <img class="card-img-top" height="100%" width="auto" src="../../siteimg/news/baloziNetherlands/1.jpg" alt="Ambassador of Netherlands">
                            <div class="card-body">
                                <h5 class="card-title"></h5>
                                <p class="card-text">Balozi wa Netherland nchini Tanzania, Bw. Weibe de boer akizungumza na watumishi wa Tume ya Tehama, alipofanya ziara katika makao makuu ya Tume ya TEHAMA</p>
                            </div>
                        </div>
                    </div>
                </div>
